...
**Full-duplex voice agent** - talk to an AI in real time, interrupt it mid-sentence, and get responses in ~3900ms.
...
| Component                          | Time       |
| ---------------------------------- | ---------- |
| You stop speaking → endpoint fires | ~3450ms    |
| Groq TTFT                          | ~200ms     |
| Cartesia first audio               | ~300ms     |
| **Perceived E2E**                  | **~3900ms** |
